 ...
 * description：检查是否异地登陆
 */
public class CheckIsLogInRemotely implements HandlerInterceptor {
    private Jedis redis;
    private Logger logger = LoggerFactory.getLogger(CheckIsLogInRemotely.class);
    @Override
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        logger.info("进入CheckIsLogInRemotely的preHandle");
